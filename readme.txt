...
= 1.7.1 =
* Added: Type Product column
* Changed: Product Name format for Product Variations
* Fixed: Product Category column
 
= 1.7 =
* Added: Advanced settings option to Settings screen
* Fixed: PHP warning on Settings screen
* Added: Support for overriding date format
